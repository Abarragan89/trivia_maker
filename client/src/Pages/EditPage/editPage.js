        ...
        <>
            ...
            {loggedIn && data ?
                <form id='create-game-form' onSubmit={handleSubmit}>
                        ...
                        {data.getUserGames.gameData.map((gameSet, gameIndex) => (
                            <li>
                                ...
                                <section className='question-content'>
                                    <input type='text' data-category={`c${gameIndex}`} defaultValue={gameSet.category ? gameSet.category : 'Enter Topic'} 
                                    ...
                                    {gameSet.clues.map((clues, index) => (
                                        <div className='single-question-div'>
                                            ...
                                            <textarea data-category={`c${index}`} placeholder='Question' 
                                            defaultValue={clues.question} name={`q${index}`} className='question-input'></textarea>
                                            <textarea data-category={`c${index}`} placeholder='Answer' 
                    ...
                    <button type='submit' id='create-game-btn'>Update Game</button>
                </form>
                :
